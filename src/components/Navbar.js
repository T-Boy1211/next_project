  ...
  return (
    <nav className="bg-gradient-to-r from-red-400 via-pink-400 to-purple-400 shadow-md">
      <div className="flex items-center justify-between max-w-6xl mx-auto py-3 px-4">
        ...
        <div className="flex items-center justify-center bg-transparent rounded-full px-3 py-1 sm:w-10">
          <input
            type="search"
            placeholder="Search..."
            className="outline rounded-3xl outline-pink-500 px-2 py-1 text-gray-700 bg-transparent"
          />
