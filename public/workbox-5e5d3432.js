define(["exports"], function (t) {
  ...
  function O(t) {
    return t !== IDBDatabase.prototype.transaction ||
      ...
      : function (e, ...s) {
          ...
          return C.set(n, e.sort ? e.sort() : [e]), k(n);
        };
  }
  function T(t) {
  ...
  function k(t) {
    ...
    const e = T(t);
    return e !== t && (I.set(t, e), E.set(e, t)), e;
  }
  const B = (t) => E.get(t);
        ...
        });
      {
        ...
        (n = await e.fetch(
          ...
          s &&
            a &&
            "no-cors" !== t.mode &&
            (this.H(), await e.cachePut(t, n.clone()));
      }
      return n;
    }
    async A(t, e) {
  ...
  class tt {
    ...
    addToCacheList(t) {
      ...
      for (const n of t) {
        ...
        if ((this.$.set(r, t), this.G.set(r, i), e.length > 0)) {
